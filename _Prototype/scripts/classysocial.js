...
ClassySocial = function(e) {
    ...
    var data = {
        bubble: {
            holder: '<a class="main" title="Contact Me ..." alt="Contact Me ...">' + '<img src="[IMAGE_URL]" title="Contact Me ..." alt="Contact Me ..."/>' + "</a>" + '<div class="network_holder"></div>',
            ...
            orientations: {
                ...
                line: function() {
                    ...
                    var e = 500, t = 100, r = $(n).find(".network_button").length, i = l, s = e + (r - 1) * t, o = 1;
